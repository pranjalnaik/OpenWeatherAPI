package com.pjnaik.openweatherapp.services;
...
import com.pjnaik.openweatherapp.MainActivity;
import com.pjnaik.openweatherapp.domain.Current;
import com.pjnaik.openweatherapp.domain.Daily;
import com.pjnaik.openweatherapp.domain.Hourly;
import com.pjnaik.openweatherapp.domain.UserSetting;
import com.pjnaik.openweatherapp.domain.Weather;
...
public class WeatherServiceRunnable implements Runnable {
    ...
    @Override
    public void run() {
        String WEATHER_URL = "https://api.openweathermap.org/data/2.5/onecall?lat="+lat+"&lon="+lon+"&appid=87fee533e3735a58444302be038b755a&units="+unit+"&lang=en&exclude=minutely";
    ...
    private Current getCurrent(JSONObject jCurrent, long timezoneOffset) throws JSONException {
        ...
        return new Current(
                ...
                "UV Index: "+jCurrent.getString("uvi"),
